# -*- coding: utf-8 -*-
"""
Created on Tue May 20 08:35:33 2025
...
In this script, the iterative NMF is executed in one step.
The maximum number of iterations is given by: "miter"
...
for i in range(0,n_comp):
    ax.plot(scale_cm1[firstchannel:lastchannel+1],H[i], label=f"comp. {i}",linewidth=1)
...
with open(Bildpfad+"\\NMFinfo.txt", "w") as datei:
